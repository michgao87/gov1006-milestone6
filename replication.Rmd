...
# grid.arrange(rasterGrob(fig_1a), widths = c(1,1), layout_matrix = rbind(c(1, NA)))
# grid.arrange(rasterGrob(fig_1b), rasterGrob(fig_1c), ncol = 2)
# grid.arrange(rasterGrob(fig_1d), rasterGrob(fig_1e), ncol = 2)    

grid.arrange(rasterGrob(fig_1a, width = unit(0.75,"npc"), height = unit(1,"npc")), rasterGrob(fig_1b, width = unit(0.75,"npc"), height = unit(1,"npc")), rasterGrob(fig_1c, width = unit(0.75,"npc"), height = unit(1,"npc")), 
             rasterGrob(fig_1d, width = unit(0.75,"npc"), height = unit(1,"npc")), rasterGrob(fig_1e, width = unit(0.75,"npc"), height = unit(1,"npc")),
             widths = c(1,1,1,1), 
...
less <- ggplot(df) + geom_col(aes(x = group, y = Less)) + coord_flip() + 
  xlab('') + ylab('') + labs(title = "Share of Democratic Donors Expecting Below\nGroup's Influence in Party to Decrease") +
...
colnames(tech_survey) <- c(" ", "Tech", "Dem Donors", "Rep Donors", "Dem (Public)", "Rep (Public)", "Millionaires (Public)")
