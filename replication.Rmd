...
Figure 4 sums up the main finding of the paper -- technology entrepreneurs' distinctive bundle of policy views. Technology entrepreneurs have liberal views in many areas. On social issues, globalism, and redistribution, they are more supportive than the Democratic public, educated Democrats, and Democratic donors. Yet on the topic of regulation (the questions included "government regulation of business does more harm than good" and "regulate 'gig' workers like regular workers"), tech entrepreneurs were significantly less supportive than those same groups of Democrats.  On regulation, tech entrepreneurs actually resemble Republicans much more. 

## Replication

Numbers I have not been able to replicate correctly: 1) in Table 2: "Technology Entrepreneurs Do Not Agree with Libertarian Philosophy," my percentage for Tech Entrepreneurs is slightly off, even though my numbers for the other groups are correct; 2) in Table 6: "Technology Entrepreneurs No More Likely to Oppose Regulating Technology Products Than Democratic Groups," my linear regression contains the wrong coefficients relating to the "tech product/service" indicator variable, even though the other parts of the regression are correct. I suspect this is due to scaling the variable incorrectly so I will continue looking into that.

Aesthetics I am looking to improve on: There are a few figures with multiple plots that I would look to display more similarly to the way they are in the original paper. Also, while I used gt for the non-regression tables, I will explore creating them in Latex for greater customization in PDF format. 
...
tech_survey <- cbind(c("Do Reg, Do Redist", 
                       "Don't Reg, Do Redist", 
                       "Do Reg, Don't Redist", 
                       "Don't Reg, Don't Redist"), 
                     tech_survey, millionaires)
colnames(tech_survey) <- c(" ", "Tech", "Dem Donors", "Rep Donors", "Dem (Public)", 
                           "Rep (Public)", "Millionaires (Public)")
as_tibble(tech_survey) %>% 
  gt()%>%
  tab_header(title = "Table 3: Technology Entrepreneurs Uniquely Support Redistribution But Oppose Regulation",
             subtitle = md("&nbsp;")) %>%
